...
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install net-tools wine qemu-kvm *zenhei* xz-utils dbus-x11 curl firefox-esr gnome-system-monitor mate-system-monitor  git xfce4 xfce4-terminal tightvncserver wget unzip zip inetutils-ping vim sudo -y
